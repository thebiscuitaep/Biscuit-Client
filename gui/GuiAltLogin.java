...
import net.minecraft.ImageDownloader;
...
extends GuiScreen {
    ...
    @Override
    protected void actionPerformed(GuiButton button) throws MalformedURLException, IOException {
        switch (button.id) {
            case 1: {
    ...
    @Override
    protected void keyTyped(char character, int key) throws MalformedURLException, IOException {
        try {
